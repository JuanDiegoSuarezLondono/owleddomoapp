...
class _RutinasLista extends State<RutinasLista> {
  ...
  _actualizarRutina(Rutina rutina, String tiempo) {
    ServiciosRutina.actualizarRutina(_usuario, rutina.rutina_id, rutina.persona_producto_id,
                                     ...
                                     rutina.nuevo_valor)
        .then((result) {
          if ( result == "EXITO" && _actualizarTiempo == true) {
            _actualizarTiempo = false;
            setState(() {
              _estado = 5;
            });
        ...
        child: MaterialButton(
          ...
          child: Container(
            ...
            child: AvatarGlow(
              ...
              endRadius: _width/1.333333333333333,
      ...
      return
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            color: _rutinasLista[indexVariable].nuevo_valor[indexAccion] == "1" ? colores.obtenerColorCuatro()
                : colores.obtenerColorInactivo(),
            boxShadow: [
              BoxShadow(
                color: _rutinasLista[indexVariable].nuevo_valor[indexAccion] == "1" ? colores.obtenerColorCuatro()
                  ...
                  onPressed: () {
                    ...
                    ServiciosRutina.borrarRutina(_usuario, rutina.rutina_id, rutina.persona_producto_id,
                        ...
                        .then((result) {
                          ...
                          tratarError.estadoServicioActualizarSnackbar(result, context);
                        });
                    },
                ),
                ElevatedButton(
